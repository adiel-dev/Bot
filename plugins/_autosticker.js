...
//await this.sendFile(m.chat, stiker, 'error.jpg', null, m, false, { contextInfo: { mentionedJid: [m.sender], externalAdReply: { showAdAttribution: true, mediaType: 'VIDEO', mediaUrl: null, title: 'Cuentas Oficiales', body: 'By @NetfreeMx, thumbnail: img, sourceUrl: `https://www.prueba.com`}}})  
}}
return !0
}
